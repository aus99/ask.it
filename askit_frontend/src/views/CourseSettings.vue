    ...
    <main class="p-8 bg-[#D6FFD6] dark:bg-slate-800 overflow-visible">
        ...
        <div class="flex-row flex gap-x-20 mt-20">
            ...
            <button v-on:click="deleteModule" type="button"
                    class=" shadow-[3px_3px_0px_0px_#000000] dark:shadow-[3px_3px_0px_0px_#ffffff] dark:border-0 transition w-60 rounded bg-red-600 px-4 text-sm font-semibold text-white py-2 hover:bg-blue-500 focus:ring-4 focus:ring-pink-400 focus:outline-none border-2 border-black">
                Delete Module
            </button>
        </div>
    </main>
